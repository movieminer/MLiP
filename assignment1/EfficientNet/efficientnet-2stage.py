...
def train_loop(df, fold):
    ...
    train_dataset1 = EEGDataset(train_folds[train_folds['total_evaluators'] < 10], kaggle_spectrograms=kaggle_spectrograms, eeg_spectrograms=eeg_spectrograms, mode="train", augment="both")
    train_dataset2 = EEGDataset(train_folds[train_folds['total_evaluators'] >= 10], kaggle_spectrograms=kaggle_spectrograms, eeg_spectrograms=eeg_spectrograms, mode="train", augment="both")
    ...
    train_loader1 = DataLoader(train_dataset2,
                              batch_size=config.BATCH_SIZE_TRAIN,
                              shuffle=True,
                              num_workers=config.NUM_WORKERS, pin_memory=True, drop_last=True)
    train_loader2 = DataLoader(train_dataset1,
                              batch_size=config.BATCH_SIZE_TRAIN,
                              shuffle=True,
                              num_workers=config.NUM_WORKERS, pin_memory=True, drop_last=True)
    ...
    valid_folds1, train_losses1, val_losses1 = train_stage(train_loader1, valid_loader, valid_folds, model, 0.0067194)
    valid_folds2, train_losses2, val_losses2 = train_stage(train_loader2, valid_loader, valid_folds, model, 0.02)
